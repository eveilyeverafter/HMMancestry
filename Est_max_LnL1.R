...
# ddply, c_est_fwd_back, c_est_fwd_back_diploid, and parLapply are all required for this function to work
#' @export est_maxLnL
est_maxLnL <- function(dat, ploidy="haploid", initial_p_assign="NULL", initial_scale=5e-05, tolerance=1e-04, n_coarse_steps=5, n_iterations=30, plot=FALSE, cores=4)
{
	# initial iteration
	n = 0 
